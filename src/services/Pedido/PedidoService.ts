...
async create(data: Pedido): Promise<Pedido> {
  return  this.pedidoRepository.query(
    ...
    [data.id, data.created_at, data.desconto, data.mesa, data.id_mesa, data.obs, data.pedidos, data.status, data.valor, data.created_by, data.acepted_by, data.acepted_at, data.update_by, data.finished_by, data.finished_at, data.update_at],
  );
}
